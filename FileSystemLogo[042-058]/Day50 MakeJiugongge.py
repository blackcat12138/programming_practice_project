'''
    [050]、用python制作九宫格切图器
    1.将一张图片切分成9块,类似九宫格的效果。运行程序,单击"选择图片" 按钮,
      选择需切分png格式的图片文件,单击"切分图片"按钮;
      将图片平均切分成9块保存在程序所在的路径下。
    2.核心技术：
        Pillow(PIL)模块能够实现图像归档、图像展示、图像处理等功能。
'''
...
main.iconbitmap('E://05_job src//programming_practice_project//FileSystemLogo[042-058]//data//mr.png')  # 窗口图标
