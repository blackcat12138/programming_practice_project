'''
    ...
    1.从25岁开始缴纳养老金,缴纳15年、20年、25年、30年.....退休后每月能拿多少钱,通过python分析预测。
        养老金的钱分两个部分:基础养老金、个人账户养老金
        基础养老金(当地)：上年度在岗职工月平均工资和本人指数化月平均缴纳工资的平均值为基数，
                         缴纳每满1年发给1%
        个人账号养老金=个人账号储存额/计发月份（65岁退休为101个月）
