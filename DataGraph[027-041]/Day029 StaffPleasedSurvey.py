...
main.iconbitmap('E:/05_job src/programming_practice_project/DataGraph[027-041]/data/mr.ico')
# 生成主界面
frame = tk.Frame()
frame.grid(row=0,
           column=0,
           ...
           pady=1)
# 添加背景图片
imgInfo = PhotoImage(file='E:/05_job src/programming_practice_project/DataGraph[027-041]/data/bg2.png')
